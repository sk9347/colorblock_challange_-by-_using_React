...
const RedAndGreenmid = () => {
  ...
  const handleStart = () => {
    ...
    const randomInterval = Math.floor(Math.random() * 800) + 500;
  ...
  return (
    <>
      <h1 style={{ textAlign: "center", color: "white" }}>Medium Level</h1>
      <div className="body">
        ...
        <div className="container">
          ...
          {points === 15 && <div className="win-message">You Win!</div>}
